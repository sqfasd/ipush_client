...
-(void)showMenu:(UIView *)sender
{
    ...
    @[
      [KxMenuItem menuItem:@"删除"
                     image:[UIImage imageNamed:@"btn_delete_h"]
                    target:self
...
- (void)showPhoto:(CDVInvokedUrlCommand*)command
{
    ...
    if (controller.localImgPath && controller.localImgPath.length>0) {
        ...
        [self.mediaFocusController showImageFromURL:[NSURL URLWithString:url] fromRect:CGRectMake(20, 100, 300, 200)withPlaceholder:[UIImage imageNamed:@"defaultImage_1"]];
    }
