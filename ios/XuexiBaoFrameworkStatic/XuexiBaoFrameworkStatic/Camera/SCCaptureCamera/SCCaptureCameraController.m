...
- (void)addbottomContainerView {
    ...
    CGFloat bottomH = 60; //_captureManager.previewLayer.frame.origin.y + _captureManager.previewLayer.frame.size.height;
...
{
    if (!stillImage) {
        ShowAlertView(NSLocalizedString(@"alert_title", @"alert_title"), NSLocalizedString(@"alert_empty_image", @"alert_empty_image"), NSLocalizedString(@"OK", @"OK"), nil);
        return;
    }
